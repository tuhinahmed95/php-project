...
<body>
        ...
        <div class="container"> 
            ...
            <div class="header"> 
                <h1 class="first">Hi,Welcome Back</h1>                
                <h3 class="five">All Sales (Offline) <br> 932,210</h3>
                <h3 class="six">All Sales (Online) <br> 431,007</h3>
                <h3 class="seven">Customer Rating <br> 12,775</h3>
            ...
            <div class="main"> 
                <h3 class="first-div">Start Date <br>April 01/2024</h3>
