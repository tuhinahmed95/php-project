...
?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #0F172A;"><!-- navbar navbar-inverse navbar-fixed-top Starts -->
        ...
        <div class="navbar-header"><!-- navbar-header Starts -->
            ...
            <a class="navbar-brand" href="index.php?dashboard" style="color:#fff; font-family: Rancho , cursive;">Dhaka Mart</a>


        </div><!-- navbar-header Ends -->

        <ul class="nav navbar-right top-nav" style="color:#fff;"><!-- nav navbar-right top-nav Starts -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse Starts -->
            ...
            <ul class="nav navbar-nav side-nav" style="background-color:#0F172A;"><!-- nav navbar-nav side-nav Starts -->

                <li><!-- li Starts -->

                    <a href="index.php?dashboard" style="color:#fff;">

                        <i class="fa fa-fw fa-dashboard" style="color:#fff;"></i> Dashboard
                ...
                <li><!-- Products li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#products" style="color:#fff;">

                        <i class="fa fa-fw fa-table" style="color:#fff;"></i> Products
...
<i class="fa fa-fw fa-caret-down"></i> -->
                ...
                <li><!-- manufacturer li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#manufacturers" style="color:#fff;"><!-- anchor Starts -->

                        <i class="fa fa-fw fa-briefcase" style="color:#fff;"></i> Supplier

                        <i class="fa fa-fw fa-caret-down" style="color:#fff;"></i>
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#p_cat" style="color:#fff;">

                        <i class="fa fa-fw fa-pencil" style="color:#fff;"></i> Sub Categories
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#cat" style="color:#fff;">

                        <i class="fa fa-fw fa-arrows-v" style="color:#fff;"></i> Categories
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#pur" style="color:#fff;">

                        <i class="fa fa-fw fa-arrows-v" style="color:#fff;"></i> Purchase

                        <i class="fa fa-fw fa-caret-down"></i>

                    </a>

                    <ul id="pur" class="collapse">

                        <li>
                            <a href="index.php?insert_purchase"> Purchase Products</a>
                        </li>

                        <li>
                            <a href="index.php?view_purchase"> Purchage Report</a>
                        </li>
...
<i class="fa fa-fw fa-edit"></i> Edit About Us Page
                ...
                <li><!-- Coupons Section li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#coupons" style="color:#fff;"><!-- anchor Starts -->

                        <i class="fa fa-fw fa-arrows-v" style="color:#fff;"></i> Coupons
...
<i class="fa fa-fw fa-caret-down"></i> -->
                ...
                <li>
                    ...
                    <a href="index.php?view_customers" style="color:#fff;">

                        <i class="fa fa-fw fa-edit" style="color:#fff;"></i> View Customers
                ...
                <li>
                    ...
                    <a href="index.php?view_orders" style="color:#fff;">

                        <i class="fa fa-fw fa-list" style="color:#fff;"></i> View Orders
                ...
                <li>
                    ...
                    <a href="index.php?view_payments" style="color:#fff;">

                        <i class="fa fa-fw fa-pencil" style="color:#fff;"></i> View Payments
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#users" style="color:#fff;">

                        <i class="fa fa-fw fa-gear" style="color:#fff;"></i> Users
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="logout.php" style="color:#fff;">
                        ...
                        <i class="fa fa-fw fa-power-off" style="color:#fff;"></i> Log Out
