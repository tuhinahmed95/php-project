...
$insert_manufacturer = "insert into manufacturers (manufacturer_title,manufacturer_top,product_name,manufacturer_image) values ('$manufacturer_name','$manufacturer_top','$product_name','$manufacturer_image')";
