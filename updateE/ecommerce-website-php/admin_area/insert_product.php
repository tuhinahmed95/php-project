              ...
              <div class="form-group"><!-- form-group Starts -->
                ...
                <div class="col-md-6">
                  ...
                  <select name="product_title" class="form-control">
                    ...
                    $get_cat = "select * from purchage ";

                    $run_purchage = mysqli_query($con, $get_cat);

                    while ($row_cat = mysqli_fetch_array($run_purchage)) {

                      $product_title = $row_cat['product_title'];

                      echo "<option value='$product_title'>$product_title</option>";
                    }
