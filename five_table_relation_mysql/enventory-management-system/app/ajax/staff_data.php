   ...
   $data[] = array(
      ...
      "action"=>'
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <a href="index.php?page=edit_staff&&edit_id='.$row['id'].'" class="btn btn-secondary btn-sm rounded-0" type="button"><i class="fas fa-edit"></i></a>

            <a href="" class="btn btn-danger btn-sm rounded-0" id="staff_delete_btn" data-id="'.$row['id'].'" type="button"><i class="fas fa-trash-alt"></i></a>
          </div>
