			...
			<div class="container">
				<div class="banner_book_1">
					<ul>
						...
						<li class="dl4"><a href="booking.php">Book Now</a> </li>
					</ul>
				</div>
			</div>
		</div>
							...
							<ul>
								<li>
									<div class="tr-room-type-list">
										...
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1">Price Per Night</span> <span class="hot-list-p3-2">$940</span> <a href="booking.php" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
									</div>
								</li>
								<li>
									<div class="tr-room-type-list">
										...
										<div class="col-md-6 tr-room-type-list-2">
											...
											<p><b>Amenities: </b>Television, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more.. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1">Price Per Night</span> <span class="hot-list-p3-2">$720</span> <a href="booking.php" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
									</div>
								</li>
								<li>
									<div class="tr-room-type-list">
										...
										<div class="col-md-6 tr-room-type-list-2">
											...
											<p><b>Amenities: </b>Television, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more.. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1">Price Per Night</span> <span class="hot-list-p3-2">$560</span> <a href="booking.php" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
									</div>
								</li>
								<li>
									<div class="tr-room-type-list">
										...
										<div class="col-md-6 tr-room-type-list-2">
											<h4>Normal Rooms</h4>
											<p><b>Amenities: </b>Television, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more.. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1">Price Per Night</span> <span class="hot-list-p3-2">$420</span> <a href="booking.php" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
									</div>
								</li>
							</ul>
						</div>
				...
				<div class="col-md-3 tour_r">
					...
					<div class="tour_right tour_offer">
						...
						<h4>$500<span class="n-td">
							...
							</h4> <a href="booking.php" class="link-btn">Book Now</a> </div>
					<!--====== TRIP INFORMATION ==========-->
