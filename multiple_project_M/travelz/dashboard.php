					...
					<div class="db-2-main-com">
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db2.png" alt="" /><span>Travel Bookings</span>
								<ul>
									<li><a href="db-travel-details.php">Honeymoon Package</a>
									</li>
									<li><a href="db-payment.php">Payment Status <span class="db-done">Done</span></a>
									</li>
									<li><a href="db-travel-details.php">Remaining Days - 14</a>
									</li>
									<li><a href="db-travel-details.php">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund.php">Cancel this booking</a>
									</li>
								</ul>
							</div>
						</div>
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db3.png" alt="" /><span>Hotel Bookings</span>
								<ul>
									<li><a href="db-hotel-details.php">GTC Grand Chola</a>
									</li>
									<li><a href="db-payment.php">Payment Status <span class="db-not-done">not-Done</span></a>
									</li>
									<li><a href="db-hotel-details.php">Remaining Days - 14</a>
									</li>
									<li><a href="db-hotel-details.php">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund.php">Cancel this booking</a>
									</li>
								</ul>
						...
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db1.png" alt="" /><span>Event Bookings</span>
								<ul>
									<li><a href="db-event-details.php">Eiffel Tower Party</a>
									</li>
									<li><a href="db-payment.php">Payment Status <span class="db-not-done">not-Done</span></a>
									</li>
									<li><a href="db-event-details.php">Remaining Days - 14</a>
									</li>
									<li><a href="db-event-details.php">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund.php">Cancel this booking</a>
									</li>
								</ul>
